...
CAF_FI/
 ...
 │
 ├── 30_ml_next/              # 다음 소비 예측 모델 서버
 ├── 31_ml_fraud/             # 이상거래 탐지 모델 서버
 │
 ├── 40_nginx/                # API 게이트웨이 + 라우팅
 │
 ├── 50_llm_category/         # LLM 기반 카테고리 분류 서비스
 ├── 51_llm_analysis/         # LLM 기반 소비분석 서비스
 ├── 52_llm_cleo/             # (Optional) 추가 챗봇 or LLM 서버
 │
